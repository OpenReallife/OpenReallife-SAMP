...
#define SCRIPT_VERSION "v21w14a" //v[Jahr]w[Kalenderwoche][Revision]
...
main()
{
	...
	print(" https://github.com/user/openreallife");
	print("----------------------------------\n");
}
...
public OnPlayerRequestClass(playerid, classid)
{
	...
	SetPlayerPos(playerid, 1858.3783, 1343.1572, 15.3746);
	SetPlayerCameraPos(playerid, 1858.3783, 1343.1572, 15.3746);
	SetPlayerCameraLookAt(playerid, 1858.3783, 1343.1572, 15.3746);
	return 1;
}

public OnPlayerConnect(playerid)
{
	SendClientMessage(playerid, GREEN_BRIGHT, "Wilkommen!");
	return 1;
}
